...
def test_debug_override():
    ...
    try:
        collaborator_normal = CollaboratorPi("collaborator_config.ini", debug_override=False)
    ...
    try:
        collaborator_debug = CollaboratorPi("collaborator_config.ini", debug_override=True)
