...
EDITABLE_CONFIG_FIELDS = {
    "leader": [
        ...
        {"key": "tick_interval", "section": "DEFAULT", "type": "float", "label": "Sync Interval", "default": 0.05, "min": 0.02, "max": 5.0, "tooltip": "How often (seconds) to broadcast time sync messages. Lower = tighter sync but more network traffic."},
        {"key": "emulated_render_lag", "section": "DEFAULT", "type": "float", "label": "Web UI Render Lag Offset", "default": 0.05, "min": 0, "max": 1.0, "tooltip": "Offset (seconds) to subtract from the Web UI time/preview to match physical screens (e.g. 0.05 = 50ms)."},
        {"key": "max_drift", "section": "DEFAULT", "type": "float", "label": "Max Drift", "default": 0.3, "min": 0, "max": 10.0, "tooltip": "Maximum allowed sync deviation before a hard seek (jump) is forced."},
        {"key": "min_drift", "section": "DEFAULT", "type": "float", "label": "Min Drift", "default": 0.01, "min": 0, "max": 1.0, "tooltip": "Minimum deviation to ignore (prevents jitter)."},
        {"key": "kp", "section": "DEFAULT", "type": "float", "label": "P-Gain", "default": 0.25, "min": 0, "max": 10.0, "tooltip": "Proportional gain for playback speed adjustment. Higher = faster catchup."},
        {"key": "max_samples", "section": "DEFAULT", "type": "int", "label": "Max Samples", "default": 3, "min": 1, "max": 100, "tooltip": "Number of sync samples to average for drift calculation."},
        {"key": "min_rate", "section": "DEFAULT", "type": "float", "label": "Min Rate", "default": 0.9, "min": 0.01, "max": 1.0, "tooltip": "Minimum playback speed allowed for slow-down correction."},
        {"key": "max_rate", "section": "DEFAULT", "type": "float", "label": "Max Rate", "default": 1.2, "min": 1.0, "max": 10.0, "tooltip": "Maximum playback speed allowed for catch-up correction."},
        ...
        {"key": "video_width", "section": "DEFAULT", "type": "int", "label": "Video Width", "default": 0, "min": 0, "max": 7680, "tooltip": "Force video width (0 = auto/native, default)."},
