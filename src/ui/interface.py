...
class StatusDisplay:
    ...
    @staticmethod
    def show_leader_status(system_state: Any, collaborators: Dict[str, Dict], 
...
class ProgressDisplay:
    ...
    def show_progress(self, current_time: float, total_time: float, 
        ...
        while True:
            ...
            if choice in ['q', 'quit', 'exit']:
                ...
                try:
                    ...
                    ErrorDisplay.show_error(f"Error executing option '{choice}'", str(e))
            else:
